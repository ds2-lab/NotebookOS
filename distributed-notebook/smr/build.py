...
add_checked_function(mod, 'smr_LogNode_Append', None, [param('int64_t', '_handle'), param('int64_t', 'val'), param('bool', 'goRun')])
add_checked_function(mod, 'smr_LogNode_AddNode', None, [param('int64_t', '_handle'), param('int64_t', 'id'), param('char*', 'addr'), param('bool', 'goRun')])
add_checked_function(mod, 'smr_LogNode_RemoveNode', None, [param('int64_t', '_handle'), param('int64_t', 'id'), param('bool', 'goRun')])
