...
parser.add_argument("-i", "--inventory-file", type = str, default = "./inventory_file.ini", help = "Path to the Ansible inventory file.")
parser.add_argument("-v", "--vars-file", type = str, default = "./ansible_vars.yml", help = "Path to the Ansible 'vars' file.")
...
if args.list_playbooks:
    ...
    counter:int = 1
    for colloquial_name, playbook_file in AllPlaybooks.items():
