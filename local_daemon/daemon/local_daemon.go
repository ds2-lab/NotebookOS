...
func New(connectionOptions *jupyter.ConnectionInfo, localDaemonOptions *domain.LocalDaemonOptions,
	...
	daemon := &LocalScheduler{
		...
		id:                             dockerNodeId,
		nodeName:                       nodeName,
		kernelsStopping:                hashmap.NewConcurrentMap[chan struct{}](16),
		kernels:                        hashmap.NewConcurrentMap[scheduling.KernelReplica](16),
		kernelInvokers:                 hashmap.NewConcurrentMap[invoker.KernelInvoker](16),
		prewarmKernels:                 hashmap.NewConcurrentMap[scheduling.KernelReplica](16),
		kernelClientCreationChannels:   hashmap.NewConcurrentMap[chan *proto.KernelConnectionInfo](16),
		kernelDebugPorts:               hashmap.NewConcurrentMap[int](256),
...
func (d *LocalScheduler) addResourceSnapshotToJupyterMessage(jMsg *messaging.JupyterMessage, kernel scheduling.KernelReplica) (*resource.ManagerSnapshot, error) {
