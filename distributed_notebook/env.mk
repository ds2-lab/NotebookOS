...
PYTHON3_PATH=$(shell python3.11 -c "import sys; print(sys.executable)")
PYTHON3_VERSION:=$(shell python3.11 -c "from sysconfig import get_paths;import sys;info = get_paths();sys.stdout.write(info['include'])") # $(shell echo $(PYTHON3_PATH) | sed -E 's/^.+\/Versions\///')
PYTHON3_INCLUDES_PATH:=$(shell python3.11 -c "from sysconfig import get_paths;import sys;info = get_paths();sys.stdout.write(info['include'])")
