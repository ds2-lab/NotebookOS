...
#
# Much of this code is taken from https://github.dev/SeanNaren/deepspeech.pytorch/.
#
...
class DeepSpeech2(DeepLearningModel):
    def __init__(
        ...
        self._scheduler = torch.optim.lr_scheduler.ExponentialLR(
            ...
            gamma=0.99  # Annealing applied to learning rate after each epoch
        )
    ...
    def get_seq_lens(self, input_length):
        ...
        :return: 1D Tensor scaled by model
        """
        return self.model.get_seq_lens(input_length)
