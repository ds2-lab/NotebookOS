...
from distributed_notebook.datasets.nlp.imdb_truncated import IMDbLargeMovieReviewTruncated
...
def test_imdb_download_fresh_with_bert():
    if os.path.isdir(IMDbLargeMovieReviewTruncated.root_directory):
        shutil.rmtree(IMDbLargeMovieReviewTruncated.root_directory)
    ...
    assert os.path.isdir(IMDbLargeMovieReviewTruncated.root_directory)
