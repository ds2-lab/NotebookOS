...
add_checked_function(mod, 'smr_LogNode_Start', None, [param('int64_t', '_handle'), param('int64_t', 'config'), param('bool', 'goRun')])
add_checked_function(mod, 'smr_LogNode_StartAndWait', None, [param('int64_t', '_handle'), param('int64_t', 'config'), param('bool', 'goRun')])
add_checked_string_function(mod, 'smr_LogNode_GetSerializedStateJson', retval('char*'), [param('int64_t', '_handle')])
...
add_checked_string_function(mod, 'smr_LogNode_ReadDataDirectoryFromHDFS', retval('char*'), [param('int64_t', '_handle')])
add_checked_function(mod, 'smr_LogNode_WriteDataDirectoryToHDFS', None, [param('int64_t', '_handle'), param('char*', 'serialized_state'), param('PyObject*', 'resolve', transfer_ownership=False), param('bool', 'goRun')])
...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'store_path'), param('int64_t', 'id'), param('char*', 'hdfsHostname'), param('char*', 'hdfs_data_directory'), param('int64_t', 'peerAddresses'), param('int64_t', 'peerIDs'), param('bool', 'join')])
