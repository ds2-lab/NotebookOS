...
add_checked_function(mod, 'smr_LogNode_WriteDataDirectoryToHDFS', None, [param('int64_t', '_handle'), param('int64_t', 'serialized_state'), param('PyObject*', 'resolve', transfer_ownership=False), param('bool', 'goRun')])
...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'store_path'), param('int64_t', 'id'), param('char*', 'hdfsHostname'), param('bool', 'shouldLoadDataFromHdfs'), param('int64_t', 'peerAddresses'), param('int64_t', 'peerIDs'), param('bool', 'join'), param('int64_t', 'httpDebugPort')])
