...
add_checked_function(mod, 'smr_LogNode_WriteDataDirectoryToHDFS', None, [param('int64_t', '_handle'), param('PyObject*', 'resolve', transfer_ownership=False), param('bool', 'goRun')])
