...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'store_path'), param('int64_t', 'id'), param('char*', 'hdfsHostname'), param('int64_t', 'peerAddresses'), param('int64_t', 'peerIDs'), param('bool', 'join')])
