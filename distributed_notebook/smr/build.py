...
add_checked_function(mod, 'smr_LogNode_ReadDataDirectoryFromHDFS', retval('int64_t'), [param('int64_t', '_handle')])
...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'store_path'), param('int64_t', 'id'), param('char*', 'hdfsHostname'), param('char*', 'hdfs_data_directory'), param('int64_t', 'peerAddresses'), param('int64_t', 'peerIDs'), param('bool', 'join'), param('int64_t', 'debug_port')])
