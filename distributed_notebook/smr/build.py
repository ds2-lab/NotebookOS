...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'storePath'), param('int64_t', 'id'), param('char*', 'hdfsHostname'), param('bool', 'shouldLoadDataFromHdfs'), param('int64_t', 'peerAddresses'), param('int64_t', 'peerIDs'), param('bool', 'join'), param('int64_t', 'httpDebugPort'), param('char*', 'deploymentMode')])
