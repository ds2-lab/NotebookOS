...
add_checked_function(mod, 'smr_NewLogNode', retval('int64_t'), [param('char*', 'store_path'), param('int64_t', 'id'), param('int64_t', 'peer_addresses'), param('int64_t', 'peer_ids'), param('bool', 'join')])
