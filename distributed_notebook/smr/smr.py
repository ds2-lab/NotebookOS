...
"""
# python wrapper for package github.com/zhangjyr/distributed-notebook/smr within overall package smr
...
# ---- Constructors ---
def NewLogNode(storePath, id, hdfsHostname, shouldLoadDataFromHdfs, peerAddresses, peerIDs, join, httpDebugPort):
	"""NewLogNode(str storePath, int id, str hdfsHostname, bool shouldLoadDataFromHdfs, []str peerAddresses, []int peerIDs, bool join, int httpDebugPort) object
	...
	"""
	return LogNode(handle=_smr.smr_NewLogNode(storePath, id, hdfsHostname, shouldLoadDataFromHdfs, peerAddresses.handle, peerIDs.handle, join, httpDebugPort))
def NewConfig():
	"""NewConfig() object"""
