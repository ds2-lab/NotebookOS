...
#cgo CFLAGS: "-I/home/ubuntu/Python-3.11.9/Include" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/usr/local/lib" "-lpython3.11d" -ldl -lm
