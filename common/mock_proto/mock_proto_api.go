...
// Source: ./common/proto/gateway_grpc.pb.go
//
...
func (m *MockLocalGatewayClient) ResourcesSnapshot(ctx context.Context, in *proto.Void, opts ...grpc.CallOption) (*proto.NodeResourcesSnapshot, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// ResourcesSnapshot mocks base method.
func (m *MockLocalGatewayServer) ResourcesSnapshot(arg0 context.Context, arg1 *proto.Void) (*proto.NodeResourcesSnapshot, error) {
	m.ctrl.T.Helper()
