...
func (c *clusterGatewayClient) ListKernels(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ListKernelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.ClusterGateway/ListKernels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterGatewayClient) SetTotalVirtualGPUs(ctx context.Context, in *SetVirtualGPUsRequest, opts ...grpc.CallOption) (*VirtualGpuInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.ClusterGateway/SetTotalVirtualGPUs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterGatewayClient) GetClusterActualGpuInfo(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ClusterActualGpuInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.ClusterGateway/GetClusterActualGpuInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterGatewayClient) GetClusterVirtualGpuInfo(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ClusterVirtualGpuInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.ClusterGateway/GetClusterVirtualGpuInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterGatewayClient) RegisterKernelResourceSpec(ctx context.Context, in *ResourceSpecRegistration, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/gateway.ClusterGateway/RegisterKernelResourceSpec", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClusterGateway_ListKernels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.ClusterGateway/ListKernels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterGateway_SetTotalVirtualGPUs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.ClusterGateway/SetTotalVirtualGPUs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterGateway_GetClusterActualGpuInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.ClusterGateway/GetClusterActualGpuInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterGateway_GetClusterVirtualGpuInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.ClusterGateway/GetClusterVirtualGpuInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterGateway_RegisterKernelResourceSpec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.ClusterGateway/RegisterKernelResourceSpec",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
