...
var file_common_gateway_gateway_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x70, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xa4, 0x02, 0x0a, 0x26, 0x4b,
	0x65, 0x72, 0x6e, 0x65, 0x6c, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x6f, 0x72, 0x74, 0x1a, 0x3b, 0x0a, 0x0d, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x45,
	...
	0x64, 0x32, 0xa8, 0x03, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x47, 0x61, 0x74,
	...
	0x64, 0x22, 0x00, 0x12, 0x4e, 0x0a, 0x14, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x65, 0x4b, 0x65,
	0x72, 0x6e, 0x65, 0x6c, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x12, 0x14, 0x2e, 0x67, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x6e, 0x66,
	0x6f, 0x1a, 0x1e, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x4d, 0x69, 0x67, 0x72,
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x32, 0x97, 0x04, 0x0a,
	...
	0x65, 0x77, 0x61, 0x79, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0a, 0x41,
	0x64, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x12, 0x1a, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x41, 0x64, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x42, 0x82, 0x01, 0x0a, 0x37, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
...
var file_common_gateway_gateway_proto_depIdxs = []int32{
	...
	10, // 18: gateway.LocalGateway.AddReplica:input_type -> gateway.AddReplicaRequest
	0,  // 19: gateway.ClusterGateway.ID:output_type -> gateway.ProvisionerId
	16, // 20: gateway.ClusterGateway.RemoveHost:output_type -> gateway.Void
	9,  // 21: gateway.ClusterGateway.MigrateKernelReplica:output_type -> gateway.MigrateKernelResponse
	14, // 22: gateway.ClusterGateway.NotifyKernelRegistered:output_type -> gateway.KernelRegistrationNotificationResponse
	16, // 23: gateway.ClusterGateway.SmrReady:output_type -> gateway.Void
	16, // 24: gateway.ClusterGateway.SmrNodeAdded:output_type -> gateway.Void
	2,  // 25: gateway.LocalGateway.SetID:output_type -> gateway.HostId
	12, // 26: gateway.LocalGateway.StartKernel:output_type -> gateway.KernelConnectionInfo
	12, // 27: gateway.LocalGateway.StartKernelReplica:output_type -> gateway.KernelConnectionInfo
	15, // 28: gateway.LocalGateway.GetKernelStatus:output_type -> gateway.KernelStatus
	16, // 29: gateway.LocalGateway.KillKernel:output_type -> gateway.Void
	16, // 30: gateway.LocalGateway.StopKernel:output_type -> gateway.Void
	15, // 31: gateway.LocalGateway.WaitKernel:output_type -> gateway.KernelStatus
	16, // 32: gateway.LocalGateway.SetClose:output_type -> gateway.Void
	16, // 33: gateway.LocalGateway.AddReplica:output_type -> gateway.Void
