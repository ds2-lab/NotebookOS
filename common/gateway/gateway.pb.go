...
var file_common_gateway_gateway_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x32, 0xe8, 0x04,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x82, 0x01, 0x0a, 0x37, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x7a, 0x68, 0x61, 0x6e, 0x67, 0x6a, 0x79, 0x72,
	0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x64, 0x2d, 0x6e, 0x6f, 0x74,
	0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x67, 0x61, 0x74,
	0x65, 0x77, 0x61, 0x79, 0x42, 0x0c, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x50, 0x72, 0x6f,
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x62, 0x06, 0x70,
...
var file_common_gateway_gateway_proto_depIdxs = []int32{
	...
	6,  // 19: gateway.LocalGateway.PrepareToMigrate:input_type -> gateway.ReplicaInfo
	0,  // 20: gateway.ClusterGateway.ID:output_type -> gateway.ProvisionerId
	17, // 21: gateway.ClusterGateway.RemoveHost:output_type -> gateway.Void
	10, // 22: gateway.ClusterGateway.MigrateKernelReplica:output_type -> gateway.MigrateKernelResponse
	15, // 23: gateway.ClusterGateway.NotifyKernelRegistered:output_type -> gateway.KernelRegistrationNotificationResponse
	17, // 24: gateway.ClusterGateway.SmrReady:output_type -> gateway.Void
	17, // 25: gateway.ClusterGateway.SmrNodeAdded:output_type -> gateway.Void
	2,  // 26: gateway.LocalGateway.SetID:output_type -> gateway.HostId
	13, // 27: gateway.LocalGateway.StartKernel:output_type -> gateway.KernelConnectionInfo
	13, // 28: gateway.LocalGateway.StartKernelReplica:output_type -> gateway.KernelConnectionInfo
	16, // 29: gateway.LocalGateway.GetKernelStatus:output_type -> gateway.KernelStatus
	17, // 30: gateway.LocalGateway.KillKernel:output_type -> gateway.Void
	17, // 31: gateway.LocalGateway.StopKernel:output_type -> gateway.Void
	16, // 32: gateway.LocalGateway.WaitKernel:output_type -> gateway.KernelStatus
	17, // 33: gateway.LocalGateway.SetClose:output_type -> gateway.Void
	17, // 34: gateway.LocalGateway.AddReplica:output_type -> gateway.Void
	9,  // 35: gateway.LocalGateway.PrepareToMigrate:output_type -> gateway.PrepareToMigrateResponse
