...
type AddReplicaOperation struct {
	createdAt                    time.Time
	client                       Kernel
	metadata                     hashmap.HashMap[string, interface{}]
	spec                         *proto.KernelReplicaSpec
	replicaJoinedSmrChannel      chan struct{}
	replicaRegisteredChannel     chan struct{}
	podOrContainerStartedChannel chan string
	persistentId                 string
	id                           string
	...
	kernelId                     string
	smrNodeId                    int32
	replicaRegistered            bool
	replicaJoinedSMR             bool
	podOrContainerStarted        bool
}
