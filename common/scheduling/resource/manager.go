...
// The AllocationManager allocates and deallocates Resources to/from kernel replicas scheduled to run on the node.
//
...
type AllocationManager struct {
	...
	// method and the *ResourceWrapperSnapshot structs created by the AllocationManager's ResourcesSnapshot method share
...
// tracked by the AllocationManager. The ResourceWrapperSnapshot struct is JSON-serializable.
...
// method and the *ResourceWrapperSnapshot structs created by this method (i.e., the AllocationManager's ArbitraryResourceSnapshot
...
func (m *AllocationManager) ResourcesSnapshot() *ResourceWrapperSnapshot {
	m.mu.Lock()
	defer m.mu.Unlock()
...
//
// Important note: the *ResourceWrapperSnapshot structs created by the AllocationManager's ArbitraryResourceSnapshot method and
