...
type ResourceStateWrapper interface {
	// IdleResources returns the idle Resources managed by a AllocationManager.
	...
	// PendingResources returns the pending Resources managed by a AllocationManager.
	...
	// CommittedResources returns the committed Resources managed by a AllocationManager.
	...
	// SpecResources returns the spec Resources managed by a AllocationManager.
...
// Resources is a struct used by the AllocationManager to track its total idle, pending, committed, and spec Resources
...
// ResourceWrapperSnapshot encapsulates a JSON-compatible snapshot of the resource quantities of the AllocationManager.
type ResourceWrapperSnapshot struct {
	...
	// ManagerId is the unique ID of the AllocationManager struct from which the ResourceWrapperSnapshot was constructed.
