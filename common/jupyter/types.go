...
type DistributedKernelConfig struct {
	LocalDaemonAddr                      string               `json:"local_daemon_addr"`
	...
	SimulateWriteAfterExec               bool                 `json:"simulate_write_after_execute"`
	SimulateWriteAfterExecOnCriticalPath bool                 `json:"simulate_write_after_execute_on_critical_path"`
