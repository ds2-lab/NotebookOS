...
//
//	mockgen -source kernel.go -package mock_client -destination /home/scusemua/go/pkg/distributed-notebook/common/jupyter/mock_client/mock_kernel.go
//
...
func (m *MockKernelReplicaClient) BusyStatus() (string, *types.JupyterMessage) {
	m.ctrl.T.Helper()
...
func (m *MockKernelReplicaClient) RequestWithHandler(ctx context.Context, prompt string, typ types.MessageType, msg *types.JupyterMessage, handler core.KernelMessageHandler, done func()) error {
	m.ctrl.T.Helper()
...
func (m *MockKernelReplicaClient) ShouldAckMessages() bool {
	m.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) ShouldAckMessages() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShouldAckMessages", reflect.TypeOf((*MockKernelReplicaClient)(nil).ShouldAckMessages))
}
