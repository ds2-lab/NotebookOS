...
// Source: /home/bcarver2/go/pkg/distributed-notebook/common/jupyter/client/kernel.go
...
func (mr *MockKernelReplicaClientMockRecorder) AddDestFrame(frames, destID, jOffset interface{}) *gomock.Call {
...
func (mr *MockKernelReplicaClientMockRecorder) AddIOHandler(topic, handler interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) BindSession(sess interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) ExtractDestFrame(frames interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) InitializeIOSub(handler, subscriptionTopic interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) InitializeShellForwarder(handler interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) RequestWithHandler(ctx, prompt, typ, msg, handler, done, timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) SetContext(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) SetReplicaID(replicaId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) SetResourceSpec(spec interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) SkipIdentities(frames interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKernelReplicaClientMockRecorder) Socket(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
