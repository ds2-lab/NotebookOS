...
// Source: /home/scusemua/go/pkg/distributed-notebook/common/jupyter/client/types.go
//
// Generated by this command:
//
//	mockgen -source /home/scusemua/go/pkg/distributed-notebook/common/jupyter/client/types.go -package mock_client -destination /home/scusemua/go/pkg/distributed-notebook/common/jupyter/mock_client/mock_kernel.go
//
...
func (m *MockAbstractDistributedKernelClient) ExecutionComplete(snapshot types0.HostResourceSnapshot[types0.ArbitraryResourceSnapshot], msg *types.JupyterMessage) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAbstractKernelClientMockRecorder) GetPodOrContainerName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPodOrContainerName", reflect.TypeOf((*MockAbstractKernelClient)(nil).GetPodOrContainerName))
}
...
func (m *MockAbstractKernelClient) KernelStoppedTraining(snapshot types0.HostResourceSnapshot[types0.ArbitraryResourceSnapshot]) error {
	m.ctrl.T.Helper()
...
func (m *MockAbstractKernelClient) UpdateResourceSpec(arg0 types0.Spec) error {
	m.ctrl.T.Helper()
...
func (mr *MockAbstractKernelClientMockRecorder) UpdateResourceSpec(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateResourceSpec", reflect.TypeOf((*MockAbstractKernelClient)(nil).UpdateResourceSpec), arg0)
}
...
func (mr *MockAbstractKernelClientMockRecorder) WaitForPendingExecuteRequests() *gomock.Call {
	mr.mock.ctrl.T.Helper()
