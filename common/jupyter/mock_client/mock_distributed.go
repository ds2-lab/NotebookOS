...
//
//	mockgen -source distributed.go -package mock_client -destination /home/scusemua/go/pkg/distributed-notebook/common/jupyter/mock_client/mock_distributed.go
//
...
func (m *MockDistributedKernelClient) RequestWithHandler(ctx context.Context, prompt string, typ types.MessageType, msg *types.JupyterMessage, handler core.KernelMessageHandler, done func()) error {
	m.ctrl.T.Helper()
