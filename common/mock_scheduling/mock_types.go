...
// Source: /home/scusemua/go/pkg/distributed-notebook/common/scheduling/types.go
//
// Generated by this command:
//
//	mockgen -source /home/scusemua/go/pkg/distributed-notebook/common/scheduling/types.go -package mock_scheduling -destination /home/scusemua/go/pkg/distributed-notebook/common/mock_scheduling/mock_types.go
//
...
func (m *MockAbstractSession) GetReplicaContainer(replicaId int32) (*scheduling.Container, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockAbstractSessionMockRecorder) GetReplicaContainer(replicaId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReplicaContainer", reflect.TypeOf((*MockAbstractSession)(nil).GetReplicaContainer), replicaId)
}
...
func (mr *MockAbstractSessionMockRecorder) SessionStartedTraining(container, snapshot any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SessionStartedTraining", reflect.TypeOf((*MockAbstractSession)(nil).SessionStartedTraining), container, snapshot)
}
