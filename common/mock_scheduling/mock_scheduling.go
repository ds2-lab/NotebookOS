...
func (m *MockKernel) ActiveExecution() *execution.Execution {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execution")
...
func (mr *MockKernelMockRecorder) ActiveExecution() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execution", reflect.TypeOf((*MockKernel)(nil).ActiveExecution))
}
...
func (m *MockKernel) CurrentActiveExecution() *execution.Execution {
	m.ctrl.T.Helper()
...
func (m *MockKernel) EnqueueActiveExecution(attemptId int, msg *messaging.JupyterMessage) *execution.Execution {
	m.ctrl.T.Helper()
...
func (m *MockKernel) GetActiveExecutionByExecuteRequestMsgId(msgId string) (*execution.Execution, bool) {
	m.ctrl.T.Helper()
...
func (m *MockKernel) SetActiveExecution(activeExecution *execution.Execution) {
	m.ctrl.T.Helper()
...
// MockKernelReplica is a mock of Replica interface.
