...
func (mr *MockHostMockRecorder) AllocationManager() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllocationManager", reflect.TypeOf((*MockHost)(nil).AllocationManager))
}
