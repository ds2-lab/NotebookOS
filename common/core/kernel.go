...
type KernelMessageHandler func(KernelInfo, jupyter.MessageType, [][]byte) error
...
type Kernel interface {
	...
	RequestWithHandler(ctx context.Context, prompt string, typ jupyter.MessageType, msg [][]byte, handler KernelMessageHandler, done func()) error
