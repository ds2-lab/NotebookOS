...
var file_common_proto_gateway_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x49, 0x44, 0x22, 0xa8, 0x02, 0x0a, 0x11, 0x4b, 0x65, 0x72,
	...
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x32, 0xbb,
	0x0c, 0x0a, 0x12, 0x44, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x64, 0x43, 0x6c,
	...
	0x44, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x4e, 0x0a, 0x10,
	...
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x32, 0xb4, 0x08, 0x0a,
	...
	0x65, 0x54, 0x6f, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x75, 0x61,
...
var file_common_proto_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_common_proto_gateway_proto_goTypes = []any{
	...
	nil,                                            // 52: gateway.ClusterActualGpuInfo.GpuInfoEntry
	nil,                                            // 53: gateway.ClusterVirtualGpuInfo.GpuInfoEntry
	nil,                                            // 54: gateway.VirtualGpuAllocations.AllocationsEntry
	nil,                                            // 55: gateway.KernelRegistrationNotificationResponse.ReplicasEntry
...
var file_common_proto_gateway_proto_depIdxs = []int32{
	...
	56, // 2: gateway.VirtualDockerNode.createdAt:type_name -> google.protobuf.Timestamp
	...
	52, // 5: gateway.ClusterActualGpuInfo.gpuInfo:type_name -> gateway.ClusterActualGpuInfo.GpuInfoEntry
	53, // 6: gateway.ClusterVirtualGpuInfo.gpuInfo:type_name -> gateway.ClusterVirtualGpuInfo.GpuInfoEntry
	46, // 7: gateway.DistributedJupyterKernel.kernelSpec:type_name -> gateway.KernelSpec
	...
	54, // 10: gateway.VirtualGpuAllocations.allocations:type_name -> gateway.VirtualGpuAllocations.AllocationsEntry
	46, // 11: gateway.KernelReplicaSpec.kernel:type_name -> gateway.KernelSpec
	39, // 12: gateway.MigrationRequest.targetReplica:type_name -> gateway.ReplicaInfo
	37, // 13: gateway.KernelSpec.resourceSpec:type_name -> gateway.ResourceSpec
	47, // 14: gateway.KernelRegistrationNotification.connectionInfo:type_name -> gateway.KernelConnectionInfo
	37, // 15: gateway.KernelRegistrationNotification.resourceSpec:type_name -> gateway.ResourceSpec
	55, // 16: gateway.KernelRegistrationNotificationResponse.replicas:type_name -> gateway.KernelRegistrationNotificationResponse.ReplicasEntry
	37, // 17: gateway.KernelRegistrationNotificationResponse.resourceSpec:type_name -> gateway.ResourceSpec
	35, // 18: gateway.ClusterActualGpuInfo.GpuInfoEntry.value:type_name -> gateway.GpuInfo
	...
	39, // 26: gateway.ClusterGateway.SmrNodeAdded:input_type -> gateway.ReplicaInfo
	20, // 27: gateway.ClusterGateway.Notify:input_type -> gateway.Notification
	51, // 28: gateway.DistributedCluster.InducePanic:input_type -> gateway.Void
	51, // 29: gateway.DistributedCluster.ClusterAge:input_type -> gateway.Void
	51, // 30: gateway.DistributedCluster.SpoofNotifications:input_type -> gateway.Void
	51, // 31: gateway.DistributedCluster.Ping:input_type -> gateway.Void
	19, // 32: gateway.DistributedCluster.PingKernel:input_type -> gateway.PingInstruction
	51, // 33: gateway.DistributedCluster.ListKernels:input_type -> gateway.Void
	32, // 34: gateway.DistributedCluster.SetTotalVirtualGPUs:input_type -> gateway.SetVirtualGPUsRequest
	51, // 35: gateway.DistributedCluster.GetClusterActualGpuInfo:input_type -> gateway.Void
	51, // 36: gateway.DistributedCluster.GetClusterVirtualGpuInfo:input_type -> gateway.Void
	40, // 37: gateway.DistributedCluster.MigrateKernelReplica:input_type -> gateway.MigrationRequest
	38, // 38: gateway.DistributedCluster.FailNextExecution:input_type -> gateway.KernelId
	51, // 39: gateway.DistributedCluster.RegisterDashboard:input_type -> gateway.Void
	51, // 40: gateway.DistributedCluster.GetVirtualDockerNodes:input_type -> gateway.Void
	51, // 41: gateway.DistributedCluster.GetDockerSwarmNodes:input_type -> gateway.Void
	51, // 42: gateway.DistributedCluster.GetNumNodes:input_type -> gateway.Void
	11, // 43: gateway.DistributedCluster.SetNumClusterNodes:input_type -> gateway.SetNumClusterNodesRequest
	7,  // 44: gateway.DistributedCluster.AddClusterNodes:input_type -> gateway.AddClusterNodesRequest
	3,  // 45: gateway.DistributedCluster.RemoveSpecificClusterNodes:input_type -> gateway.RemoveSpecificClusterNodesRequest
	5,  // 46: gateway.DistributedCluster.RemoveClusterNodes:input_type -> gateway.RemoveClusterNodesRequest
	...
	38, // 54: gateway.LocalGateway.KillKernel:input_type -> gateway.KernelId
	38, // 55: gateway.LocalGateway.StopKernel:input_type -> gateway.KernelId
	19, // 56: gateway.LocalGateway.PingKernel:input_type -> gateway.PingInstruction
	38, // 57: gateway.LocalGateway.WaitKernel:input_type -> gateway.KernelId
	51, // 58: gateway.LocalGateway.SetClose:input_type -> gateway.Void
	45, // 59: gateway.LocalGateway.AddReplica:input_type -> gateway.ReplicaInfoWithAddr
	45, // 60: gateway.LocalGateway.UpdateReplicaAddr:input_type -> gateway.ReplicaInfoWithAddr
	39, // 61: gateway.LocalGateway.PrepareToMigrate:input_type -> gateway.ReplicaInfo
	51, // 62: gateway.LocalGateway.GetActualGpuInfo:input_type -> gateway.Void
	51, // 63: gateway.LocalGateway.GetVirtualGpuInfo:input_type -> gateway.Void
	32, // 64: gateway.LocalGateway.SetTotalVirtualGPUs:input_type -> gateway.SetVirtualGPUsRequest
	51, // 65: gateway.LocalGateway.GetVirtualGpuAllocations:input_type -> gateway.Void
	38, // 66: gateway.LocalGateway.YieldNextExecution:input_type -> gateway.KernelId
	27, // 67: gateway.ClusterGateway.ID:output_type -> gateway.ProvisionerId
	51, // 68: gateway.ClusterGateway.RemoveHost:output_type -> gateway.Void
	44, // 69: gateway.ClusterGateway.MigrateKernelReplica:output_type -> gateway.MigrateKernelResponse
	49, // 70: gateway.ClusterGateway.NotifyKernelRegistered:output_type -> gateway.KernelRegistrationNotificationResponse
	51, // 71: gateway.ClusterGateway.SmrReady:output_type -> gateway.Void
	51, // 72: gateway.ClusterGateway.SmrNodeAdded:output_type -> gateway.Void
	51, // 73: gateway.ClusterGateway.Notify:output_type -> gateway.Void
	51, // 74: gateway.DistributedCluster.InducePanic:output_type -> gateway.Void
	0,  // 75: gateway.DistributedCluster.ClusterAge:output_type -> gateway.ClusterAgeResponse
	51, // 76: gateway.DistributedCluster.SpoofNotifications:output_type -> gateway.Void
	18, // 77: gateway.DistributedCluster.Ping:output_type -> gateway.Pong
	18, // 78: gateway.DistributedCluster.PingKernel:output_type -> gateway.Pong
	26, // 79: gateway.DistributedCluster.ListKernels:output_type -> gateway.ListKernelsResponse
	34, // 80: gateway.DistributedCluster.SetTotalVirtualGPUs:output_type -> gateway.VirtualGpuInfo
	22, // 81: gateway.DistributedCluster.GetClusterActualGpuInfo:output_type -> gateway.ClusterActualGpuInfo
	23, // 82: gateway.DistributedCluster.GetClusterVirtualGpuInfo:output_type -> gateway.ClusterVirtualGpuInfo
	44, // 83: gateway.DistributedCluster.MigrateKernelReplica:output_type -> gateway.MigrateKernelResponse
	51, // 84: gateway.DistributedCluster.FailNextExecution:output_type -> gateway.Void
	2,  // 85: gateway.DistributedCluster.RegisterDashboard:output_type -> gateway.DashboardRegistrationResponse
	13, // 86: gateway.DistributedCluster.GetVirtualDockerNodes:output_type -> gateway.GetVirtualDockerNodesResponse
	16, // 87: gateway.DistributedCluster.GetDockerSwarmNodes:output_type -> gateway.GetDockerSwarmNodesResponse
	33, // 88: gateway.DistributedCluster.GetNumNodes:output_type -> gateway.NumNodesResponse
	12, // 89: gateway.DistributedCluster.SetNumClusterNodes:output_type -> gateway.SetNumClusterNodesResponse
	8,  // 90: gateway.DistributedCluster.AddClusterNodes:output_type -> gateway.AddClusterNodesResponse
	4,  // 91: gateway.DistributedCluster.RemoveSpecificClusterNodes:output_type -> gateway.RemoveSpecificClusterNodesResponse
	6,  // 92: gateway.DistributedCluster.RemoveClusterNodes:output_type -> gateway.RemoveClusterNodesResponse
	...
	51, // 100: gateway.LocalGateway.KillKernel:output_type -> gateway.Void
	51, // 101: gateway.LocalGateway.StopKernel:output_type -> gateway.Void
	18, // 102: gateway.LocalGateway.PingKernel:output_type -> gateway.Pong
	50, // 103: gateway.LocalGateway.WaitKernel:output_type -> gateway.KernelStatus
	51, // 104: gateway.LocalGateway.SetClose:output_type -> gateway.Void
	51, // 105: gateway.LocalGateway.AddReplica:output_type -> gateway.Void
	51, // 106: gateway.LocalGateway.UpdateReplicaAddr:output_type -> gateway.Void
	43, // 107: gateway.LocalGateway.PrepareToMigrate:output_type -> gateway.PrepareToMigrateResponse
	35, // 108: gateway.LocalGateway.GetActualGpuInfo:output_type -> gateway.GpuInfo
	34, // 109: gateway.LocalGateway.GetVirtualGpuInfo:output_type -> gateway.VirtualGpuInfo
	34, // 110: gateway.LocalGateway.SetTotalVirtualGPUs:output_type -> gateway.VirtualGpuInfo
	30, // 111: gateway.LocalGateway.GetVirtualGpuAllocations:output_type -> gateway.VirtualGpuAllocations
	51, // 112: gateway.LocalGateway.YieldNextExecution:output_type -> gateway.Void
	67, // [67:113] is the sub-list for method output_type
	21, // [21:67] is the sub-list for method input_type
