...
type CommonOptions struct {
	...
	RemoteStorageEndpoint              string `name:"remote-remote_storage-endpoint"           json:"remote-remote_storage-endpoint"            yaml:"remote-remote_storage-endpoint"              description:"Hostname of the remote remote_storage. The SyncLog's remote remote_storage client will connect to this."`
	RemoteStorage                      string `name:"remote-remote_storage" json:"remote-remote_storage" yaml:"remote-remote_storage" description:"The type of remote remote_storage we're using, either 'hdfs' or 'redis'"`
