...
type CommonOptions struct {
	...
	RemoteStorageEndpoint              string `name:"remote-storage-endpoint"           json:"remote-storage-endpoint"            yaml:"remote-storage-endpoint"              description:"Hostname of the remote remote_storage. The SyncLog's remote remote_storage client will connect to this."`
	RemoteStorage                      string `name:"remote-storage" json:"remote-storage" yaml:"remote-storage" description:"The type of remote remote_storage we're using, either 'hdfs' or 'redis'"`
